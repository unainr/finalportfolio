...
const Experience = () => {
	return (
		<section
			id="services"
			className=" px-4 sm:px-6 lg:px-8 w-full overflow-x-hidden">
			<div className=" mx-auto">
				<div className="text-center space-y-4 mb-16 animate-fade-in">
					<h4 className="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-rose-700 font-semibold tracking-wide uppercase">
						Technical Skills
					</h4>
					...
					<p className="max-w-2xl mx-auto text-lg">
						Specializing in MERN stack development with expertise in modern
